...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_PEEKGRAPHICS);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   //Valmistellaan "grafiikkamoottori"
   GlCore->InitGraphics(hWnd, szWindowClass, szTitle, hInstance, 10, 10,rec.right-15, viewport_banchor-15, false);
